...
1. Run constitution to establish/refresh project principles
...
Use this for feature sprints that need planning + deep execution without OSS discovery overhead. Nova sits between `/blaze` (~$1.50) and `/inferno` (~$5.00) at ~$3.00 budget.
