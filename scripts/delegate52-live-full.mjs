...
const env = {
  ...
  DANTEFORGE_LLM_MAX_TOKENS: process.env.DANTEFORGE_LLM_MAX_TOKENS ?? '8192',
  DANTEFORGE_LLM_RETRY_DELAYS_MS: process.env.DANTEFORGE_LLM_RETRY_DELAYS_MS ?? '1000,3000,10000,30000,60000',
  DANTEFORGE_DELEGATE52_MODEL: MODEL,
  DANTEFORGE_DELEGATE52_FALLBACK_MODEL: process.env.DANTEFORGE_DELEGATE52_FALLBACK_MODEL ?? 'gpt-4o',
};
...
const redactedReceipt = {
  ...
  env: {
    ...
    DANTEFORGE_LLM_MAX_TOKENS: env.DANTEFORGE_LLM_MAX_TOKENS,
    DANTEFORGE_LLM_RETRY_DELAYS_MS: env.DANTEFORGE_LLM_RETRY_DELAYS_MS,
    DANTEFORGE_DELEGATE52_MODEL: env.DANTEFORGE_DELEGATE52_MODEL,
    DANTEFORGE_DELEGATE52_FALLBACK_MODEL: env.DANTEFORGE_DELEGATE52_FALLBACK_MODEL,
