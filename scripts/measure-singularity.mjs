...
// Any co-authored commit (by any tool/agent) counts as DanteForge-assisted
const COAUTHORED_PATTERN = /Co-Authored-By:/i;
// Conventional commit prefixes generated by DanteForge CLI workflows
const DANTEFORGE_SUBJECT_PATTERN = /^\[danteforge\]|^(feat|fix|refactor|score|wave|inferno|crusade)\(/i;
...
function classifyCommit(commit) {
  ...
  if (DANTEFORGE_SUBJECT_PATTERN.test(commit.subject)) return 'danteforge';
  return 'human';
}
