...
This document reflects the shipped state of DanteForge `0.9.0` (Swarm Edition).
...
Root package, VS Code extension, plugin manifests, DanteCode packages, and all agent bootstrap files are aligned to `0.9.0`.
