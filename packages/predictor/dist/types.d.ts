 ...
 */
export type DimensionName = 'functionality' | 'testing' | 'errorHandling' | 'security' | 'uxPolish' | 'documentation' | 'performance' | 'maintainability' | 'developerExperience' | 'autonomy' | 'planningQuality' | 'selfImprovement' | 'specDrivenPipeline' | 'convergenceSelfHealing' | 'tokenEconomy' | 'contextEconomy' | 'ecosystemMcp' | 'enterpriseReadiness' | 'communityAdoption' | 'causalCoherence';
