...
// applyAdversarialCalibration / excludedDimensions / cache / saveMatrix-guard / reconciliation
// suites moved to tests/compete-matrix-persistence.test.ts (750-line LOC gate).
