...
const DIMENSION_ACTIONS: Record<ScoringDimension, string> = {
  functionality:          'danteforge forge "implement missing core features"',
  testing:                'danteforge forge "add unit and integration tests"',
  errorHandling:          'danteforge forge "add try/catch and input validation"',
  security:               'danteforge forge "add input validation, CSP headers, rate limiting"',
  uxPolish:               'danteforge forge "improve error messages and CLI output"',
  documentation:          'danteforge forge "add README, CONTRIBUTING, and API docs"',
  performance:            'danteforge forge "add incremental caching and lazy loading"',
  maintainability:        'danteforge forge "reduce complexity, add type guards"',
  developerExperience:    'danteforge forge "improve onboarding and --help output"',
  autonomy:               'danteforge compete --sprint',
  planningQuality:        'danteforge plan && danteforge tasks',
  selfImprovement:        'danteforge self-improve',
  specDrivenPipeline:     'danteforge specify && danteforge plan',
  convergenceSelfHealing: 'danteforge autoforge --auto',
  tokenEconomy:           'danteforge forge "add token routing and budget fences"',
  ecosystemMcp:           'danteforge setup mcp-server',
  enterpriseReadiness:    'danteforge forge "add audit trails and compliance checks"',
