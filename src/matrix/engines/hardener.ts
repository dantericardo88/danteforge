...
export function shouldSkipCheck(dim: MatrixDimension, check: HardenCheckId): { skip: boolean; reason?: string } {
...
// Recency and runner logic live in hardener-recency.ts to keep this module small.
export { checkRecencyCheck, runHardenGate } from './hardener-recency.js';
export type { EntryPointConfig } from './hardener-recency.js';
